...
class RoIHeads(_RoIHeads):
    ...
    def forward(self, features, proposals, image_shapes, targets=None):
        # type:
        # (Dict[str, Tensor], List[Tensor], List[Tuple[int, int]], Optional[List[Dict[str, Tensor]]])
        """
        Arguments:
        ...
        if self.training:
            ...
            boxes, scores, labels, props, prob_max, scores_cls = self.postprocess_detections(class_logits, box_regression, proposals, image_shapes)
...
class FRCNN_Feature(FasterRCNN):
    ...
    def forward(self, images, targets=None):
        # type:
        # (List[Tensor], Optional[List[Dict[str, Tensor]]])
        """
        Arguments:
